...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link active" href="https://www.jose-aguilar.com/scripts/php/stripe-checkout/">Demo <span class="sr-only">(current)</span></a>
            <a class="nav-item nav-link" href="https://www.jose-aguilar.com/scripts/php/stripe-checkout/stripe-checkout.zip">Descargar</a>
            <a class="nav-item nav-link" href="https://www.jose-aguilar.com/blog/como-implementar-una-pasarela-de-pago-con-stripe-y-php/">Tutorial</a>
            <a class="nav-item nav-link" href="https://www.jose-aguilar.com/">&copy; Jose Aguilar</a>
        </div>
    </div>
</nav>
<div class="container">
    <h1>Stripe Checkout PHP</h1>
    <h2 class="lead">Envia un donativo simbolico de 1€ para agradecer este tutorial</h2>
    
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="https://www.jose-aguilar.com/blog/">Blog</a></li>
          <li class="breadcrumb-item"><a href="https://www.jose-aguilar.com/blog/como-implementar-una-pasarela-de-pago-con-stripe-y-php/">Tutorial</a></li>
          <li class="breadcrumb-item active">Stripe Checkout PHP Demo</li>
        </ol>
    </nav>
    ...
    <div class="footer-content row">
        <div class="col-lg-12">
            <div class="pull-right">
                <a href="https://www.jose-aguilar.com/blog/como-implementar-una-pasarela-de-pago-con-stripe-y-php/" class="btn btn-secondary">
                    <i class="fa fa-reply"></i> volver al tutorial
                </a>
                <a href="https://www.jose-aguilar.com/scripts/php/stripe-checkout/stripe-checkout.zip" class="btn btn-primary">
