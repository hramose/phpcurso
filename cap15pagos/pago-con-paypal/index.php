...
<html>
<head>
<title>Jose Aguilar - Pagar con PayPal de forma segura</title>
...
if (isset($_POST['submitPayment'])) {
    ...
    <form id="realizarPago" action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input name="business" type="hidden" value="testsjagreenlern@gmail.com" />
        <input name="shopping_url" type="hidden" value="http://localhost:8080/jagphpcurso/pago-con-paypal/" />
...
<form class="form-amount" action="index.php" method="post">
    <img class="logo img-responsive" src="img/logo.png" alt="Jose Aguilar" height="65" width="300"><br/>
