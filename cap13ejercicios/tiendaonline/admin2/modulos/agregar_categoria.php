...
if(isset($enviar)){
	...
	if(mysqli_num_rows($s)>0){
		alert("Ya esta categoria esta agregada a la base de datos", 2,"?p=agregar_categoria");
		//redir("");
	}else{
		$mysqli->query("INSERT INTO categorias (categoria) VALUES ('$categoria')");
		alert("Categoria Agregada", 1,"?p=agregar_categoria");
		//redir("");
	}
...
elseif(isset($eliminar)){
	...
	alert("Categoria eliminada", 1, "?p=agregar_categoria");
