...
class valormano extends mano {
    ...
    /**
     * Returns the cartas based on the strongest
     * hand that can be made with the cartas
     * available
     * 
     * @return Poker\Table\Deck
     */
    public function getHandcartas()
    {
     ...
     * depending on the cartas provided, the strength of the
    ...
    public function isStraightFlush()
    {
        ...
        {
            $flushcartas = [];
            foreach ($this->cartas as $card)
            {
                if ($card->getSuit() == $this->flushSuit)
                {
                    $flushcartas[] = clone $card;
                }
            }
            $handStrength = new HandStrength($flushcartas);
            $handStrength->sortcartas();
    ...
    public function sortcartas()
    {
        //jagreen$this->cartas->sortByDesc(function($card)
        //{
            return $this->Card;
        //});
    }
